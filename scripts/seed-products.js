...
const products = [
  ...
  { id: "marmitex-completo", category: "pratos", categoryLabel: "Marmitex completo", name: "Marmitex Completo Na Brasa", description: "Arroz, feijão, farofa, salada, batata frita e carne na brasa. Prato completo, bem servido e feito na hora.", priceCents: 3190, image: "https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=900&q=86" },
  ...
  { id: "mushroom", category: "artesanais", categoryLabel: "Artesanal", name: "Defumado da Serra", description: "Burger artesanal 180 g, provolone defumado, bacon jam, cebola crocante, rúcula e maionese de alho.", priceCents: 4290, image: "assets/burger-artesanal-defumado.png" },
...
async function main() {
  ...
  // Retire o antigo prato executivo do catálogo confiável após migrar para o marmitex.
  batch.set(db.collection("products").doc("executive-dish"), {
    active: false,
    updatedAt: FieldValue.serverTimestamp()
  }, { merge: true });
